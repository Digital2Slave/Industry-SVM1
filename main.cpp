...
//--Add by tianzhaixing Only for debug!--
//    cout<<img32.channels()<<endl;
//    cout<<pattern32.channels()<<endl;
//---------------------------------------
  ...
  vector<float> &testData, vector<float> &testResponsesData)
{
  ...
  while( images.read(frame) ){
    ...
    //--Changed by tianzhaixing correct error!--
    Mat gray_frame;
    cvtColor(frame, gray_frame, COLOR_BGR2GRAY);
    Mat pre= preprocessImage(gray_frame);
    //------------------------------------------
    // Extract features
